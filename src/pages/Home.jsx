  ...
  return (
    mostrarResultado === false ?(
      <CardContainer>
        ...
        <ButtonContainer>
            <button onClick={handleFeedbackClick}>1</button>
            <button onClick={handleFeedbackClick}>2</button>
            <button onClick={handleFeedbackClick}>3</button>
            <button onClick={handleFeedbackClick}>4</button>
            <button onClick={handleFeedbackClick}>5</button>
